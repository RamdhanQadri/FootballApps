...
import rqk.footballapps.BuildConfig
...
object TheSportDBApi {
    ...
    fun searchPlayers(teamNamePlayer: String?): String {
        return Uri.parse(BuildConfig.BASE_URL).buildUpon()
            .appendPath("api")
            .appendPath("v1")
            .appendPath("json")
            ...
            .appendQueryParameter("t", teamNamePlayer)
            .build()
            .toString()
    }

    fun searchDetailPlayers(playersName: String?): String {
        return Uri.parse(BuildConfig.BASE_URL).buildUpon()
            .appendPath("api")
            .appendPath("v1")
            .appendPath("json")
            .appendPath(BuildConfig.TSDB_API_KEY)
            .appendPath("searchplayers.php")
            .appendQueryParameter("p", playersName)
            .build()
            .toString()
    }

    fun searchEvent(eventNameTeam: String): String {
        return Uri.parse(BuildConfig.BASE_URL).buildUpon()
            .appendPath("api")
            .appendPath("v1")
            .appendPath("json")
            ...
            .appendQueryParameter("e", eventNameTeam)
            .build()
            .toString()
    }
}